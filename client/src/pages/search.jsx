...
function Search() {
    return (
        <div className='flex items-center justify-center'>
            ...
            <div className='relative flex flex-col w-full h-screen p-5 m-5 bg-white border-gray-300 border-solid rounded-lg shadow-md border-e lg:left-0 lg:w-3/4'>
                ...
                <div className="flex items-center justify-center">
                    ...
                    <hr className='self-center w-2/3 m-5 border'/>
            </div>
        </div>
    );
}
