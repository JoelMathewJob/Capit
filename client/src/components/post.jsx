...
function post({username, caption, img, dp, location}) {
  return (
    <div className="p-4 m-10 bg-gray-100">
  <div className="max-w-md bg-white border rounded-sm">
    <div className="flex items-center px-4 py-3">
      <img className="w-8 h-8 rounded-full" src={dp}/>
      <div className="ml-3 ">
    ...
    <div className="">
        <span className='self-center block m-3 text-sm antialiased font-semibold leading-tight text-wrap'>{username}<span className='mx-1 text-sm font-normal'>{caption}</span></span> 
